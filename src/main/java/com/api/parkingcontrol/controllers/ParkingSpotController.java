...
public class ParkingSpotController {
	...
	public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto){
		...
		if(parkingSpotService.existsByParkingSpotNunber(parkingSpotDto.getParkingSpotNumber())) {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Object> getOneParkinSpot(@PathVariable(value = "id") UUID id){
